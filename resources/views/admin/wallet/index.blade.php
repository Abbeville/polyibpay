...
@section('page_title', 'Admin Wallet Transactions')
...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
   <h1 class="h3 mb-0 text-gray-800">Wallet Transactions Management</h1>
   <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Admin Dashboard</a></li>
      <li class="breadcrumb-item active" aria-current="page">Wallets Transactions</li>
   </ol>
</div>
...
<div class="col-md-6">
   <div class="alert alert-info " role="alert">
     <h6><i class="fas fa-users"></i> Category in View:<b class="text-danger"> Wallet Transacts</b></h6>
