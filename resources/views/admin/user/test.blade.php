...
<div class="bg-primary">
    <div class="container d-flex justify-content-center">
      <ul class="nav secondary-nav">
        <li class="nav-item"> <a class="nav-link active" href="settings-profile.html">Account</a></li>
...
<div class="row mt-3"> 
        ...
        <div class="col-lg-9"> 
          ...
          ============================================= -->
          <div class="bg-white shadow-sm rounded p-4 mb-4">
            <h3 class="text-5 font-weight-400 d-flex align-items-center mb-4">Email Addresses<a href="#edit-email" data-toggle="modal" class="ml-auto text-2 text-uppercase btn-link"><span class="mr-1"><i class="fas fa-edit"></i></span>Edit</a></h3>
            <hr class="mx-n4 mb-4">
            <div class="form-row align-items-center">
              <p class="col-sm-3 text-muted text-sm-right mb-0 mb-sm-3">Email ID:</p>
              <p class="col-sm-9 text-3">smithrhodes1982@gmail.com<span class="badge badge-info text-1 font-weight-500 rounded-pill px-2 py-1 ml-2">Primary</span></p>
            </div>
            <div class="form-row align-items-center">
              <p class="col-sm-3 text-muted text-sm-right mb-0 mb-sm-3">Email ID:</p>
              ...
              <div class="modal-content">
                ...
                <div class="modal-body p-4">
                  <form id="emailAddresses" method="post">
                    <div class="form-group">
                      <label for="emailID">Email ID <span class="badge badge-info text-1 font-weight-500 rounded-pill px-2 py-1 ml-1">Primary</span></label>
                    ...
                    <div class="form-group">
                      <label for="emailID2">Email ID 2 - <a class="btn-link text-uppercase text-1" href="#">Make Primary</a></label>
