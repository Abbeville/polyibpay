
                                      transform="translate(-0.54)"/>
                                <path id="Fill-21"
                                      d="M2183.32,390V369a66.28,66.28,0,0,1-48.75,21c-30.47,0-44.85-16.58-44.85-43.63V247.89h36.56V332c0,19.25,10,25.59,25.6,25.59,14.13,0,25.35-7.8,31.68-15.84V247.89h36.57V390Z"
                                      transform="translate(-0.54)"/>
                                <path id="Fill-23"
                                      d="M2349.56,390V302.74c0-19.26-10-25.84-25.6-25.84-14.38,0-25.35,8-31.68,16.09v97h-36.57V247.89h36.57v17.8c9-10.24,26.08-21.21,48.5-21.21,30.71,0,45.34,17.31,45.34,44.12V390Z"
                                      transform="translate(-0.54)"/>
                                <path id="Fill-25"
                                      d="M2430,351.73V279.58h-22.91V247.65H2430V209.87h36.57v38h28v31.93h-28v62.4c0,9,4.63,15.6,12.67,15.6,5.36,0,10.73-1.95,12.68-4.38l7.8,27.78c-5.37,4.88-15.12,9-30.47,9-25.84-.24-39.25-13.4-39.25-38.51"
                                      transform="translate(-0.54)"/>
                            </g>
                        </g>
                    </svg>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 mb-5">
                    <div class="badge badge-marketing badge-pill badge-secondary-soft text-secondary mb-3">Features
                    </div>
                    <h2>Friendly Community</h2>
                    <p class="lead">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquid consectetur
                        consequatur dicta et natus, pariatur repellat veritatis vero.
                        Assumenda dicta eos excepturi laudantium libero nam numquam quos ratione temporibus
                        voluptates.</p>
                </div>
            </div>
            <div class="row mb-n10 z-1">
                <div class="col-lg-6 mb-5">
                    <div class="card h-100">
                        <div class="card-body p-5">
                            <div class="icon-stack icon-stack-xl bg-secondary-soft text-secondary mb-4"><i
                                        data-feather="users"></i></div>
                            <h5>Grow your career</h5>
                            <p class="card-text">
                                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam aspernatur
                                consequuntur hic ipsa modi, natus nemo odio sit.
                                Harum iste repellendus vel? Culpa cumque facilis ipsam laborum odit, pariatur quidem.
                ...
                <div class="col-lg-6 mb-5">
                    <div class="card h-100">
                        <div class="card-body p-5">
                            <div class="icon-stack icon-stack-xl bg-success-soft text-success mb-4"><i
                                        data-feather="trending-up"></i></div>
                            <h5>Reach sales goals</h5>
                            <p class="card-text">Attract and convert prospects into paying customers on your website by
                                implementing a new design into your lead generation strategy</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 mb-5 mb-lg-0">
                    <div class="card h-100">
                        <div class="card-body p-5">
                            <div class="icon-stack icon-stack-xl bg-primary-soft text-primary mb-4"><i
                                        data-feather="tool"></i></div>
                            <h5>Free Accessible Tools</h5>
                            <p class="card-text">
                                Lorem ipsum dolor sit amet, consectetur adipisicing elit. A alias aperiam blanditiis cum
                                deleniti deserunt earum harum inventore iusto labore libero minima numquam odio omnis,
                                praesentium quas quis repudiandae veniam.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="card h-100">
                        <div class="card-body p-5">
                            <div class="icon-stack icon-stack-xl bg-warning-soft text-warning mb-4"><i
                                        data-feather="star"></i></div>
                            <h5>Become a Star</h5>
                            <p class="card-text">
                                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Asperiores cum fugiat
                                inventore minus mollitia praesentium, sequi sint vitae!
                                Accusamus amet corporis dolor iste magni non nulla praesentium sequi sunt vel.
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <section class="bg-white border-bottom py-10">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 text-lg-right"><a class="btn btn-marketing btn-primary rounded-pill mr-3"
                                                       href="#!">Start Now</a><a
                            class="btn btn-marketing btn-transparent-dark rounded-pill" href="#!">Contact Us</a></div>
            </div>
        </div>
    </section>
